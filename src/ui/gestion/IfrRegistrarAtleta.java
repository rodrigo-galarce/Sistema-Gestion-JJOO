...
public class IfrRegistrarAtleta extends JInternalFrame {
    ...
    public IfrRegistrarAtleta(SistemaJJOO sistema) {
        super("Registrar Atleta",
                false,
                true,
                false,
                true);
    ...
    private void configurarEventos() {
        btnRegistrar.addActionListener(e -> registrarAtleta());
    ...
    private void registrarAtleta() {
        try {
            ...
            servicioDelegacion.registrarAtleta(codigoPais, dni, nombre, apellido, edad, especialidad);
            JOptionPane.showMessageDialog(this, "El atleta ha sido registrado correctamente.");
            limpiarCampos();
        } catch (Exception e) {
